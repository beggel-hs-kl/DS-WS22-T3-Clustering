...
den <- ggdendrogram(clusters, main="Dendrogram") + labs(title="Mall Customers Dendrogram")
...
```{r}
# Prepare plot
plot(clusters, cex=0.1, main="Mall Customers Dendrogram with Groups")

# Add rectangles to plot. Define colors by using border parameter
rect.hclust(clusters, k=k, border=2:6)
```
...
# Add rectangles to plot. Define colors by using border parameter
rect.hclust(clusters_all, k=k, border=6:2)
```
